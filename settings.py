...
p=platform.release()
if str(p)=="7": PLATFORM='windows7'
elif re.search('tinycore',p): PLATFORM='docker'
else: PLATFORM='linux'

BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '.'))
print "settings.py at "+BASE_DIR
logging.info("settings.py at "+BASE_DIR)
...
if PLATFORM=='windows7': #Assume on JC
    DATABASES = {
        'default': {
...
elif PLATFORM=='postgres': #db host from fig.yml, https://registry.hub.docker.com/_/postgres/
    DATABASES = {
        'default': {
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join(BASE_DIR, 'bootstrap3/templates/bootstrap3'),
    os.path.join(BASE_DIR, 'bootstrap3/templates'),
    os.path.join(BASE_DIR, 'bootstrap3/templatetags'),

    os.path.join(BASE_DIR, 'static/templatetags'),
    os.path.join(BASE_DIR, 'static/templates'),

    os.path.join(BASE_DIR, 'static/rest_framework/templatetags'),
    os.path.join(BASE_DIR, 'static/rest_framework/templates'),
    os.path.join(BASE_DIR, 'static/rest_framework'),
    os.path.join(BASE_DIR, 'static/rest_framework'),
    os.path.join(BASE_DIR, 'static/'),
    os.path.join(BASE_DIR, 'static/'),
    os.path.join(BASE_DIR, 'static/htmt'),
    os.path.join(BASE_DIR, 'static/htmt/templates'),
)
